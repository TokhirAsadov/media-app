        ...
        <div className={'p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-4'}>
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Image
                        src={"https://images.pexels.com/photos/26125407/pexels-photo-26125407/free-photo-of-a-gray-butterfly-sitting-on-a-leaf.jpeg?auto=compress&cs=tinysrgb&w=400&lazy=load"}
                        alt={""}
                        width={40}
                        height={40}
